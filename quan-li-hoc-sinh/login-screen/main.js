...
function downloadApp() {
    if (this.id == "app-store") {
        ...
        location.href = "https://play.google.com/store/apps/details?id=com.viettel.smasplus&hl=vi"
    }
...
document.getElementById("forget-pw").addEventListener("click", moveToResetScreen);
